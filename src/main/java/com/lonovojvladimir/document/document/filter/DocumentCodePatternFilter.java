...
@Component
public class DocumentCodePatternFilter implements DocumentFilter {
    @Override
    public boolean isApplicable(DocumentFilterDto documentFilterDto) {
        return documentFilterDto.getCodePattern()!=null;
    }

    @Override
    public Stream<DocumentEntity> apply(Stream<DocumentEntity> documentEntityStream, DocumentFilterDto documentFilterDto) {
        return documentEntityStream.filter(documentEntity -> documentEntity.getCode().equals(documentFilterDto.getCodePattern()));
    }
}
